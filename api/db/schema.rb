...
ActiveRecord::Schema[8.1].define(version: 20_260_615_130_000) do
  ...
  create_table 'brand_memberships', force: :cascade do |t|
    ...
    t.index %w[user_id brand_id], name: 'index_brand_memberships_on_user_id_and_brand_id', unique: true
  ...
  create_table 'event_categories', force: :cascade do |t|
    ...
    t.index %w[event_id category_id], name: 'index_event_categories_on_event_id_and_category_id', unique: true
