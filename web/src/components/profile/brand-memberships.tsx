...
const getRoleBadgeVariant = (role: string) => {
    switch (role) {
        ...
        case 'member': return 'default'; // neutral
        ...
        <div>
            ...
            <div className="flex flex-col gap-3">
                {memberships.map((membership) => {
                    ...
                    return (
                        <div key={membership.id} className="flex items-center justify-between p-3 bg-white rounded-md border border-neutral-200 shadow-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="w-10 h-10 bg-neutral-100 rounded-sm flex items-center justify-center text-neutral-400 overflow-hidden shrink-0">
                                    {membership.brand.logo_url ? (
                                        <img
                                            ...
                                            alt={brandInitials} // ✅ Дві літери для Alt
                                ...
                                <div className="flex flex-col overflow-hidden">
                                    <span className="font-semibold text-sm text-neutral-900 truncate">{membership.brand.name}</span>
                                    <span className="text-xs text-neutral-500 truncate">{membership.brand.subdomain}.eventify.com</span>
                                </div>
                            </div>
