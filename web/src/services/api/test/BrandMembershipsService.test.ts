...
import { BrandMembershipsService } from '../../BrandMembershipsService'; // Змініть шлях на ваш реальний
import { type UserRole, type CreateMembershipRequest, type PaginationParams } from '../../../types/brandMemberships';
...
describe('BrandMembershipsService', () => {
    ...
    describe('addBrandMember', () => {
        it('повинен відправляти POST-запит з правильним payload', async () => {
            const mockPayload: CreateMembershipRequest = { user_id: 'user-789', role: 'editor' as UserRole };
    ...
    describe('updateMemberRole', () => {
        it('повинен відправляти PATCH-запит для оновлення ролі', async () => {
            ...
            const result = await BrandMembershipsService.updateMemberRole(mockBrandId, mockMembershipId, newRole);
