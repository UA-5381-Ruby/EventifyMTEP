...
export default function UserProfilePage() {
    ...
    if (isLoading) return <div className="p-8 text-neutral-500 flex justify-center">Loading profile...</div>;
    if (!user) return <div className="p-8 text-error-500 flex justify-center">Profile not found.</div>;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-8 flex flex-col gap-10">
                    <div className="flex flex-col gap-6">
                        ...
                        <div>
                            <Button variant="outline" className="bg-transparent text-neutral-700 hover:bg-neutral-50">
                                Change password
                            </Button>
                        </div>
                        ...
                        <div className="flex items-center justify-end gap-3 max-w-lg pt-4">
                            ...
                            <Button variant="primary" onClick={handleSave} disabled={!isDirty || isSaving} isLoading={isSaving}>
                                Save changes
                            </Button>
                        </div>
                    </div>
